...
public class Consultants_MyConsultants_RecyclerViewAdapter extends RecyclerView.Adapter<Consultants_MyConsultants_RecyclerViewAdapter.MyViewHolder> implements Filterable {
    ArrayList<Consultant> myConsultants;
    ArrayList<Consultant> AllConsultants,preFilteredList;

    private RecyclerViewClickListener listener;

    public Consultants_MyConsultants_RecyclerViewAdapter(ArrayList<Consultant> myConsultants, RecyclerViewClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        String name = myConsultants.get(position).getName();
        String profilePic_src = myConsultants.get(position).getProfilePic_src();
        String rating = myConsultants.get(position).getRating();
        String categories = myConsultants.get(position).getCategories();
        int price = myConsultants.get(position).getPrice();
    ...
    public void listUpdate(String categoryFilter, String ratingFilter) {
        ...
        myConsultants.clear();
        myConsultants.addAll(preFilteredList);
        getFilter();
    ...
    private Filter SearchFilter = new Filter() {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            myConsultants.clear();
            myConsultants.addAll((List) filterResults.values);

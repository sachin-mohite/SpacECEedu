...
public class VideoLibrary_RecyclerViewAdapter_trending extends RecyclerView.Adapter<VideoLibrary_RecyclerViewAdapter_trending.MyViewHolder> {
    ArrayList<Topic> topics= new ArrayList<Topic>();
    private RecyclerViewClickListener listener;

    public VideoLibrary_RecyclerViewAdapter_trending(ArrayList<Topic> topics, RecyclerViewClickListener listener){
        this.topics=topics;
    ...
    @NonNull
    @Override
    public VideoLibrary_RecyclerViewAdapter_trending.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_list_item,parent,false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull VideoLibrary_RecyclerViewAdapter_trending.MyViewHolder holder, int position) {
